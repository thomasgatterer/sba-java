...
System.out.println(lehrer);
      JOptionPane.showMessageDialog(null,"Das offizielle Namensk�rzel hat min. 2, max. 4 Zeichen ODER Passwort falsch !");
    }
    else {
     try {
      ...
      else JOptionPane.showMessageDialog(null,"Benutzername und Password stimmen nicht �berein ODER Benutzer nicht gefunden !");
      }
