...
public class deflehrer extends Frame {
  ...
  if (testzahl < 1 || testzahl0 != 5 || testzahl > 4) JOptionPane.showMessageDialog(null,"Eingabe unvollständig bzw. Format falsch !");
  ...
  try  {
      ...
      if (abbruch == true) JOptionPane.showMessageDialog(null,"Kein Eintrag in der Liste !");
        ...
        stmt.executeUpdate(sql);
        JOptionPane.showMessageDialog(null,"Lehrer "+lehrerdefstr+" wurde gelöscht !");
        }
      ResultSet rs1 = stmt.executeQuery("SELECT * FROM Lehrer ORDER BY Lehrer");
      while (rs1.next()) {
