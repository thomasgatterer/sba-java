...
public class druck_klassen extends Frame {
  ...
  int lang0=0;
  int buch_count=0, buch_ges=0;//Anzahl der bestellen Bücher bzgl. Klasse
...
//        lehrer_a();
        try { // try 1
          ...
          klassenfile.write("LISTE FÜR DEN KV ZUR AUSGABE DER BESTELLTEN BÜCHER "+date+"\n\n");
          klassenfile.write(text);
          klassenfile.write("KLASSENLISTE FÜR " +klassestr+" zur Schulbuchaktion ("+(char)169+" A.Knapp)\n\n");
          klassenfile.write("Das Ergebnis der Abfrage für die "+klassestr+" Klasse:\nNr.\t\tKurztitel d. Buches\t\t\tPreis\tFach\tAnz.\tLeh.\tWert\t\tW\n\n"+
  ...
  JOptionPane.showMessageDialog(null,"Es wurden "+buch_ges+" Bücher eingegeben und "+klcb_row+" Klassenlisten auf C:/db_sba/Klassenlisten.doc erstellt");
  }
}