 ...
 * <p>Copyright: Copyright (c) 2003/04 A.pp</p>
...
public class Frame extends JFrame implements ActionListener, ItemListener {
  ...
  String klassestr = "", klassecb = "", fachtxt = "", klassetxt = "", lehrer = "";
  ...
  FileDialog open = new FileDialog(this, "Datei öffnen",FileDialog.LOAD);
      int zeilen;
      String anmeldesjstr="";
      char pwd[]=new char[6]; //Variablen für class pwdlang - pwd in Worten ausdrücken
      String pwdwort[]=new String[6];
      int pwd_counter=0;
      boolean anzeigen_klasse=true; //notwendig um itemStateChange für anzeigen(klassecb) aus- und einzuschalten; Schuljahrwechsel!!
  ...
  JTextField nrtxt = new JTextField(6);
  ...
  JComboBox klcb = new JComboBox();
  JComboBox fachcb = new JComboBox();
  JComboBox klassecb1 = new JComboBox();
 ...
 public void jbInit() throws Exception  {
    ...
    //ImageIcon image1 = new ImageIcon(getClass().getResource("/images/openFile.gif"));
    //ImageIcon image2 = new ImageIcon(getClass().getResource("/images/closeFile.gif"));
    //ImageIcon image4 = new ImageIcon(getClass().getResource("/images/schreiben.gif"));
    ...
    int newscreenSizewidth = screenSize.width-10;
    ...
    try {
      ...
      ResultSet rs = stmt.executeQuery("SELECT * FROM schuljahr ORDER BY SJ");
    ...
    schuljahrtxt.setMaximumSize(new Dimension(80, 20));
    ...
    klcb.setMaximumSize(new Dimension(40, 20));
    klcb.setMinimumSize(new Dimension(20, 20));
    klcb.setPreferredSize(new Dimension(40, 20));
    klcb.setToolTipText("Klasse anzeigen");
    klcb.setMaximumRowCount(20);

    preistxt.setMaximumSize(new Dimension(40, 20));
    preistxt.setMinimumSize(new Dimension(40, 20));
    preistxt.setPreferredSize(new Dimension(40, 20));
    //27.2.2006 Anpassen von "scroller" an die Fenstergröße (screenSize) siehe auch oben !
    scroller.setAutoscrolls(true);
    scroller.setPreferredSize(new Dimension(newscreenSizewidth-124, newscreenSizeheight-268));
    lehrertxt.setBackground(Color.yellow);
    lehrertxt.setFont(new java.awt.Font("SansSerif", 1, 12));
    lehrertxt.setMaximumSize(new Dimension(40, 20));
    lehrertxt.setMinimumSize(new Dimension(30, 20));
    lehrertxt.setPreferredSize(new Dimension(40, 20));
    klassecb1.setMaximumRowCount(20);
    fachcb.setMaximumRowCount(20);
    UStxt.setBackground(Color.lightGray);
    UStxt.setMaximumSize(new Dimension(40, 20));
    UStxt.setMinimumSize(new Dimension(40, 20));
    UStxt.setPreferredSize(new Dimension(40, 20));
    USrtxt.setBackground(Color.lightGray);
    USrtxt.setMaximumSize(new Dimension(40, 20));
    USrtxt.setMinimumSize(new Dimension(40, 20));
    USrtxt.setPreferredSize(new Dimension(40, 20));
    OSrtxt.setBackground(Color.lightGray);
    OSrtxt.setMaximumSize(new Dimension(40, 20));
    OSrtxt.setMinimumSize(new Dimension(40, 20));
    OSrtxt.setPreferredSize(new Dimension(40, 20));
    OStxt.setBackground(Color.lightGray);
    OStxt.setMaximumSize(new Dimension(40, 20));
    OStxt.setMinimumSize(new Dimension(40, 20));
    OStxt.setPreferredSize(new Dimension(40, 20));
    jToolBar.add(klcb);
    ...
    if (allow == 0) UStxt.setEditable(true);
    else UStxt.setEditable(false);
    jToolBar.add(USrlbl);
    USrlbl.setText(" US-Rel: ");
    jToolBar.add(USrtxt);
    USrtxt.setText(""+usr);
    if (allow == 0) USrtxt.setEditable(true);
    else USrtxt.setEditable(false);
    jToolBar.add(OSlbl);
    OSlbl.setText(" OS: ");
    jToolBar.add(OStxt);
    OStxt.setText(""+os);
    if (allow == 0) OStxt.setEditable(true);
    else OStxt.setEditable(false);
    jToolBar.add(OSrlbl);
    OSrlbl.setText(" OS-Rel: ");
    OSrtxt.setEditable(false);
    jToolBar.add(OSrtxt);
    OSrtxt.setText(""+osr);
    if (allow == 0) OSrtxt.setEditable(true);
    else OSrtxt.setEditable(false);
    ...
    fachcb.setMaximumSize(new Dimension(20, 20));
    fachcb.setMinimumSize(new Dimension(20, 20));
    fachcb.setPreferredSize(new Dimension(50, 20));
   ...
   try  {
    ...
    klassecb1.setMaximumSize(new Dimension(20, 20));
    klassecb1.setMinimumSize(new Dimension(20, 20));
    klassecb1.setPreferredSize(new Dimension(40, 20));
  ...
  String sqldelete = "";
    try  {
      ...
      String url = "jdbc:odbc:sba"+abmeldesjstr;
      Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
      Connection con = DriverManager.getConnection(url,"lehrer","jon96as12");
      Statement stmt = con.createStatement();
      sqldelete = "DELETE FROM Kl_Summe";
      stmt.executeUpdate(sqldelete);
      /*sqldelete = "DELETE FROM tmp WHERE Lehrer = '"+lehrertxt.getText()+"'";
      stmt.executeUpdate(sqldelete);*/
      con.close();
    }
    catch (java.lang.Exception ex){
  ...
  //Überschrieben, so daß eine Beendigung beim Schließen des Fensters möglich ist.
  ...
  public void jMenuHelphelp_actionPerformed(ActionEvent e) {
    JOptionPane.showMessageDialog(null,"1. SUCHE entweder unter Nr. (NUR ZIFFERNFOLGE) oder TITEL oder FACH\n"+
  ...
  try {
    ...
    while (rs.next()) {
      ...
      ges_uew = rs.getDouble(11);
        ...
        /*double wert1 = (mitsbx*1000)-((int)(mitsbx*1000));
        if (wert1 < 0.5) mitsbx = mitsbx*1000;
        else mitsbx = (mitsbx*1000)+1;
        int werttmp = (int)mitsbx;
        mitsbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (ohnesbx*1000)-((int)(ohnesbx*1000));
        if (wert1 < 0.5) ohnesbx = ohnesbx*1000;
        else ohnesbx = (ohnesbx*1000)+1;
        werttmp = (int)ohnesbx;
        ohnesbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (sbx*1000)-((int)(sbx*1000));
        if (wert1 < 0.5) sbx = sbx*1000;
        else sbx = (sbx*1000)+1;
        werttmp = (int)sbx;
        sbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (rel*1000)-((int)(rel*1000));
        if (wert1 < 0.5) rel = rel*1000;
        else rel = (rel*1000)+1;
        werttmp = (int)rel;
        rel = (double)werttmp/1000;*/
        ...
        /*wert1 = (uew*1000)-((int)(uew*1000));
        if (wert1 < 0.5) uew = uew*1000;
        else uew = (uew*1000)+1;
        werttmp = (int)uew;
        uew = (double)werttmp/1000;*/
        ...
        /*wert1 = (ges*1000)-((int)(ges*1000));
        if (wert1 < 0.5) ges = ges*1000;
        else ges = (ges*1000)+1;
        werttmp = (int)ges;
        ges = (double)werttmp/1000;*/
        ...
        /*wert1 = (ges_o_sbx*1000)-((int)(ges_o_sbx*1000));
        if (wert1 < 0.5) ges_o_sbx = ges_o_sbx*1000;
        else ges_o_sbx = (ges_o_sbx*1000)+1;
        werttmp = (int)ges_o_sbx;
        ges_o_sbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (ges_sbx*1000)-((int)(ges_sbx*1000));
        if (wert1 < 0.5) ges_sbx = ges_sbx*1000;
        else ges_sbx = (ges_sbx*1000)+1;
        werttmp = (int)ges_sbx;
        ges_sbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (ges_rel*1000)-((int)(ges_rel*1000));
        if (wert1 < 0.5) ges_rel = ges_rel*1000;
        else ges_rel = (ges_rel*1000)+1;
        werttmp = (int)ges_rel;
        ges_rel = (double)werttmp/1000;*/
        ...
        /*wert1 = (US_uew*1000)-((int)(US_uew*1000));
        if (wert1 < 0.5) US_uew = US_uew*1000;
        else US_uew = (US_uew*1000)+1;
        werttmp = (int)US_uew;
        US_uew = (double)werttmp/1000;*/
        ...
        /*wert1 = (ges_uew*1000)-((int)(ges_uew*1000));
        if (wert1 < 0.5) ges_uew = ges_uew*1000;
        else ges_uew = (ges_uew*1000)+1;
        werttmp = (int)ges_uew;
        ges_uew = (double)werttmp/1000;*/

      output.append(kltmp + "\t" + mitsbx + "\t\t\t" + ohnesbx + "\t\t\t" + sbx + "\t\t\t" + rel + "\t\t\t" + uew + "\n");
      }
      for (int ii = 0; ii<4; ii++) {
        ...
        if (length_tmp_int > 7) Tabb[ii] = "\t\t"; else Tabb[ii] = "\t\t\t";
      }
      output.append("\n \nUS:" + "\t" + US + Tabb[0] + US_o_sbx + Tabb[1] + US_sbx + Tabb[2] + US_rel + Tabb[3] + US_uew + "\n");
      OS = ges-US; OS_o_sbx = ges_o_sbx-US_o_sbx; OS_sbx = ges_sbx-US_sbx; OS_rel = ges_rel-US_rel; OS_uew = ges_uew-US_uew;
        ...
        /*double wert1 = (OS*1000)-((int)(OS*1000));
        if (wert1 < 0.5) OS = OS*1000;
        else OS = (OS*1000)+1;
        int werttmp = (int)OS;
        ...
        /*wert1 = (OS_o_sbx*1000)-((int)(OS_o_sbx*1000));
        if (wert1 < 0.5) OS_o_sbx = OS_o_sbx*1000;
        else OS_o_sbx = (OS_o_sbx*1000)+1;
        werttmp = (int)OS_o_sbx;
        OS_o_sbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (OS_sbx*1000)-((int)(OS_sbx*1000));
        if (wert1 < 0.5) OS_sbx = OS_sbx*1000;
        else OS_sbx = (OS_sbx*1000)+1;
        werttmp = (int)OS_sbx;
        OS_sbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (OS_rel*1000)-((int)(OS_rel*1000));
        if (wert1 < 0.5) OS_rel = OS_rel*1000;
        else OS_rel = (OS_rel*1000)+1;
        werttmp = (int)OS_rel;
        OS_rel = (double)werttmp/1000;*/
        ...
        /*wert1 = (OS_uew*1000)-((int)(OS_uew*1000));
        if (wert1 < 0.5) OS_uew = OS_uew*1000;
        else OS_uew = (OS_uew*1000)+1;
        werttmp = (int)OS_uew;
        OS_uew = (double)werttmp/1000;*/
  ...
  try {
    ...
    limitos_rel = rs.getDouble(7);
      ...
      limitges_rel = (limitus_rel/*+limitus)*0.115*/*usr) + (limitos_rel/*+limitos)*0.075*/*osr);
      limit_uew = limitges*0.15; //Ende Limits Berechnung
        ...
        /*wert1 = (limitges_sbx*1000)-((int)(limitges_sbx*1000));
        if (wert1 < 0.5) limitges_sbx = limitges_sbx*1000;
        else limitges_sbx = (limitges_sbx*1000)+1;
        werttmp = (int)limitges_sbx;
        limitges_sbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (limitges*1000)-((int)(limitges*1000));
        if (wert1 < 0.5) limitges = limitges*1000;
        else limitges = (limitges*1000)+1;
        werttmp = (int)limitges;
        limitges = (double)werttmp/1000;*/
        ...
        /*wert1 = (limit_sbx*1000)-((int)(limit_sbx*1000));
        if (wert1 < 0.5) limit_sbx = limit_sbx*1000;
        else limit_sbx = (limit_sbx*1000)+1;
        werttmp = (int)limit_sbx;
        limit_sbx = (double)werttmp/1000;*/
        ...
        /*wert1 = (limitges_rel*1000)-((int)(limitges_rel*1000));
        if (wert1 < 0.5) limitges_rel = limitges_rel*1000;
        else limitges_rel = (limitges_rel*1000)+1;
        werttmp = (int)limitges_rel;
        limitges_rel = (double)werttmp/1000;*/
        ...
        /*wert1 = (limit_uew*1000)-((int)(limit_uew*1000));
        if (wert1 < 0.5) limit_uew = limit_uew*1000;
        else limit_uew = (limit_uew*1000)+1;
        werttmp = (int)limit_uew;
        limit_uew = (double)werttmp/1000;*/
      ...
      output.append("OS:" + "\t" + OS + Tabb[0] + OS_o_sbx + Tabb[1] + OS_sbx + Tabb[2] + OS_rel + Tabb[3] + OS_uew + "\n");
      output.append("GES.:" + "\t" + ges + Tabb[4] + ges_o_sbx + Tabb[5] + ges_sbx + Tabb[6] + ges_rel + Tabb[7] + ges_uew + "\n");
      output.append("Limit:" + "\t" + (int)limitges_sbx + "\t\t\t" + (int)limitges + "\t\t\t" + (int)limit_sbx + "\t\t\t" + (int)limitges_rel + "\t\t\t" + (int)limit_uew + "\n");
      output.append("Diff.:" + "\t" + (int)(limitges_sbx-ges) + "\t\t\t" + (int)(limitges-ges_o_sbx) + "\t\t\t" + (int)(limit_sbx-ges_sbx) + "\t\t\t" + (int)(limitges_rel-ges_rel) + "\t\t\t" + (int)(limit_uew-ges_uew) + "\n");
      output.append("\nGesamt-Differenz: " + (int)(limitges-ges-ges_uew));
    con.close();
    }
  ...
  int allow = lehrer.compareTo("ADM");
  if (allow != 0) JOptionPane.showMessageDialog(null,"Keine Berechtigung !");
  else {
    int response0 = JOptionPane.showConfirmDialog(null,"Password anzeigen ?","Anzeigen der Passwörter !",JOptionPane.YES_NO_OPTION);
    if (response0 == 0) {
      output.setText("");
      try  {
          String url = "jdbc:odbc:sba"+sjstr;
    ...
    int response = JOptionPane.showConfirmDialog(null,"Password neu vergeben ?","Neuvergabe Password",JOptionPane.YES_NO_OPTION);
    if (response == 0) {
      sjstr=schuljahrtxt.getText();
      new pwd(sjstr);
        }
  ...
  if (allow != 0) JOptionPane.showMessageDialog(null,"Keine Berechtigung !");
    ...
    int response = JOptionPane.showConfirmDialog(null,"Sollen wirklich alle Datensätze gelöscht werden ?", "Daten Löschen",JOptionPane.YES_NO_CANCEL_OPTION);
    if (response == 1) {
      loeschen = false;
      JOptionPane.showMessageDialog(null,"Aktion nicht durchgeführt !");
      }
    else if (response == 0) {
      ...
      int j;
        ...
        JOptionPane.showMessageDialog(null,"Alle Datensätze wurden gelöscht !");
        }
        catch (java.lang.Exception ex){
          ex.printStackTrace();
          }
  ...
  if (allow != 0) JOptionPane.showMessageDialog(null,"Keine Berechtigung !");
    ...
    int response = JOptionPane.showConfirmDialog(null,"Sollen Datensätze in LH gelöscht werden, die älter als 4 Jahre sind ?", "Daten Löschen",JOptionPane.YES_NO_CANCEL_OPTION);
    if (response == 1) {
      loeschen = false;
      JOptionPane.showMessageDialog(null,"Aktion nicht durchgeführt !");
      }
        ...
        try  {
          ...
          LHloeschen = "DELETE FROM LehrerHand where Jahr < "+sjint_tmp;
          stmt.executeUpdate(LHloeschen);
          umbenennen("LehrerHand");
        JOptionPane.showMessageDialog(null,"Datensätze < " + sjint + " wurden gelöscht !");
        }
        catch (java.lang.Exception ex){
          ex.printStackTrace();
          }
  ...
  if (tmp == tmp1) JOptionPane.showMessageDialog(null,"Sie müssen zuerst den Text \"Nr, Kurztitel, Preis\" markieren !");
  else {
    String texttmp = output.getSelectedText();
    auswahl = new StringTokenizer(texttmp,"\t");
    int anzahl_Tokens = auswahl.countTokens();
    if (anzahl_Tokens < 3) JOptionPane.showMessageDialog(null,"Bitte Nr., Kurztitel, Preis markieren !");
    else {
  ...
  if (anmeldung == 0) JOptionPane.showMessageDialog(null,"Sie müssen sich zuerst anmelden !");
  else {
  ...
  int anz_LH=0, aa=0, ab=0, ac=0, ad=0;//Variablen für Lehrer_Hand
  ...
  try {
    ...
    for (j=0;j<klcb_row;j++) {
      klcb.setSelectedIndex(j);
      klassecb = (String) klcb.getSelectedItem();
      ResultSet rs = stmt.executeQuery("SELECT * FROM "+klassecb+" WHERE Lehrer = '"+lehrer+"' ORDER BY Fach");
      while (rs.next()) {
    ...
    //Anzahl der gesamten LehrerHand-Exemplare bestimmen und speichern
    ResultSet k = stmt.executeQuery("SELECT * FROM LehrerHand WHERE Lehrer = '"+lehrer+"' AND Jahr = "+ (Integer.parseInt(sjstr)-2000) + " ORDER BY Fach");
    while (k.next()) {
    ...
    JOptionPane.showMessageDialog(null,"Suche für eingegebene Bücher für "+lehrer+" durchgeführt !");

    a=0;b=0;c=0;d=0;v=0;x=0;
    output.setText("Eingegebene Bücher von "+lehrer+(char)lf+lz+(char)lf);
    output.append("Nr.\t\tKurztitel d. Buches\t\t\tPreis\tFach\tW\tKlasse\n"+
     "--------------------------------------------------------------------------------------------------------------------\n");
    for(a=0;a<count_buch;a++) {
      int nrtmp_lang = nrtmp[a].length();
      if (nrtmp_lang < 8) TabNr = "\t\t"; else TabNr = "\t";
      int titeltmp_lang = titeltmp[b].length();
      titeltmp_lang = 39-titeltmp_lang;
      if (titeltmp_lang > 31) Tab1="\t\t\t\t\t"; else if (titeltmp_lang > 23 && titeltmp_lang <= 31) Tab1="\t\t\t\t"; else if (titeltmp_lang > 15 && titeltmp_lang <= 23) Tab1="\t\t\t"; else if (titeltmp_lang > 7 && titeltmp_lang <= 15) Tab1 = "\t\t"; else if (titeltmp_lang <= 7) Tab1 = "\t";
      output.append(nrtmp[a] + TabNr + titeltmp[b] + Tab1 + preistmp[c] + "\t" + fachtmp[d] + "\t" + wiedertmp[v] + "\t" + klassecbtmp[x] + "\n");
      b++;c++;d++;v++;x++;
      }
    ...
    for(ad=0;ad<anz_LH;ad++) {
      ...
      if (nrtmpLH_lang < 8) TabNr = "\t\t"; else TabNr = "\t";
      int titelLH_lang = titelLHtmp[ac].length();
      titelLH_lang = 39-titelLH_lang;
      if (titelLH_lang > 31) Tab1="\t\t\t\t\t"; else if (titelLH_lang > 23 && titelLH_lang <= 31) Tab1="\t\t\t\t"; else if (titelLH_lang > 15 && titelLH_lang <= 23) Tab1="\t\t\t"; else if (titelLH_lang > 7 && titelLH_lang <= 15) Tab1 = "\t\t"; else if (titelLH_lang <= 7) Tab1 = "\t";
      output.append(nrLHtmp[aa] + TabNr + titelLHtmp[ab] + Tab1 + fachLHtmp[ac] + "\t" + "\n");
      aa++;ab++;ac++;
      }
...
/*
  //angemeldeten Lehrer aus der tmp-Datei lesen
  public void lehrer_a() {
  try {
    sjstr=schuljahrtxt.getText();
    String url = "jdbc:odbc:sba"+sjstr;
    Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
...
*/
  ...
  output.setText("Bitte eine Klasse eingeben");
    ...
    ResultSet rs = stmt.executeQuery(
     ...
     output.setText("Das Ergebnis der Abfrage für die "+klassestr+" Klasse:\nNr.\t\tKurztitel d. Buches\t\t\tPreis\tFach\tAnz.\tLehrer\tWert\tW\n"+
     "--------------------------------------------------------------------------------------------------------------------\n");
     while (rs.next()) {
     ...
     int cl = c.length();
     if (cl > 39) c = c.substring(0,39);
     cl = 39-cl; if (cl > 31) Tab1="\t\t\t\t\t"; else if (cl > 23 && cl <= 31) Tab1="\t\t\t\t"; else if (cl > 15 && cl <= 23) Tab1="\t\t\t"; else if (cl > 7 && cl <= 15) Tab1 = "\t\t"; else if (cl <= 7) Tab1 = "\t";
     ...
     output.append(b + TabNr + c + Tab1 + d + Tab2 + e + Tab3 + f+"\t"+g+"\t"+h+"\t"+i+"\n");
     int fach_rk = -1; int fach_re = -1; boolean fach_x = false;
      ...
      fach_re = e.compareTo("RE");
        if (fach_rk != 0) {
          ...
          boolean fach_rk_tmp1 = e.startsWith("XK-R");
            if (fach_rk_tmp == true || fach_rk_tmp1 == true) fach_rk = 0;
        }
        fach_x = false;
        if (fach_rk != 0) {
     ...
     else if (fach_uew == true) uewtmp = uewtmp + h;
     else htmp = htmp + h;
     buch_count++;
     }
     ...
     output.append("Bestellwert der Klasse (mit SBX): "+gtmp+" €\nBestellwert der Klasse (ohne SBX): "+htmp+" €\nBestellwert SBX: "+xtmp+" €\nBestellwert für Religion (+SBX bzw. SBX-Kombi): "+rtmp+" €\nBestellwert UeW: "+uewtmp+" €\n");
     rs.close();
     stmt.close();
     con.close();
     klcb.getItemAt(-1);
...
/*
-------------------------------------------------------------------
Einfügen eines Buches über "Eingabe"
Uew; SBX; SBXK = SBX-Kombi; Anhang -> LH nein
Einfügen von SBX ermöglichen
---------------------------------------------------------------------
*/
  ...
  if (lang1<1 || lang2<1 || lang3<1 || lang4<1 || lang5<2) {
    JOptionPane.showMessageDialog(null,"Bitte Nummer (nur ZIFFERNFOLGE), Titel, Preis, Fach und Klasse (z.B. 1a) eingeben");
    UeW.setState(false);
    }
  else { //else-Zweig 1
  if (uew == true) {
    ...
    if (nrinuew_lang > 13) {
      JOptionPane.showMessageDialog(null,"Es können max. 13 Ziffern eingegeben werden (978...können eingeben werden) !");
      nrtxt.setText("");
      nrgueltig = false;
      }
    else {
      while (nrinuew_lang > 0) {
        for (int j=0;j<nrinuew_lang;j++) {
          if (nrinpruefen[j] < 59 && nrinpruefen[j] > 47) nrgueltig = true;
          else {
            JOptionPane.showMessageDialog(null,"Die eingegebene Nummer (ISBN - nur ZIFFERNFOLGE) darf maximal aus 13 Ziffern zwischen 0 und 9 bestehen! (978...kann eingeben werden)\n");
            nrinuew_lang = 0;
            nrtxt.setText("");
            nrgueltig = false;
          }
    ...
    while (preispruefen_lang > 0) {
      for (int i=0;i<preispruefen_lang;i++) {
        if ((preispruefen[i] < 59 && preispruefen[i] > 47) || preispruefen[i] == 46) preisgueltig = true;
        else {
          JOptionPane.showMessageDialog(null,"Eingegebenes Format für den Preis ist falsch!\nVerwenden Sie nur Zahlen bzw. den 'Punkt' als Komma!");
          preispruefen_lang = 0;
          preistxt.setText("");
          preisgueltig = false;
          }
    ...
    if (preisgueltig == false || nrgueltig == false) {
      ...
      if (uewalt == true) titelinuew = titelinuew.substring(4);
      int lastIndexuew = titelinuew.length();
      if (lastIndexuew > 35) lastIndexuew = 35;
...
//Hier muss wegen der mysql Datenbank der Preis in der Anzeige von z.B. 3.0 auf 3 verändert werden bzw. 4.09 erhalten bleiben!!
        int kommanull = preisinliste.indexOf(".0");
        if (kommanull > -1) {
        int kommaint = preisinliste.indexOf(".");
        int last = preisinliste.length();
        String kommatest = preisinliste.substring(kommaint,last);
        int kommatestint = kommatest.compareTo(".0");
        if (kommatestint == 0) preisinliste = preisinliste.substring(0,kommaint);
        }
//Ende der Preiskonvertierung für die mysql Datenbank - unsympathisch !!

      ResultSet listetmp = stmt.executeQuery("SELECT * FROM Liste");
      while (listetmp.next()) {
        String nrinlistetest = listetmp.getString(2);
        int nrinlistetest_zahl = nrinliste.compareTo(nrinlistetest);
        String titelinlistetest = listetmp.getString(3);
        int lastIndex = titelinlistetest.length();
        if (lastIndex > 39) lastIndex = 39;
        titelinlistetest = titelinlistetest.substring(0,lastIndex);
        int titelinlistetest_zahl = titelinliste.compareTo(titelinlistetest);
        String preisinlistetest = listetmp.getString(4);
        int preisinlistetest_zahl = preisinliste.compareTo(preisinlistetest);
        if (nrinlistetest_zahl == 0 && titelinlistetest_zahl == 0 && preisinlistetest_zahl == 0) {
          sucheListe = true;
...
//hier ist nocht die alte Version (falls ja: titelsbx = -1; sonst entsprechender indexOf)
          String titelinlistetest_lc = titelinlistetest.toLowerCase();
...
//Ende Abfrage ob SBX
  ...
  if (sucheListe == false) {
    JOptionPane.showMessageDialog(null,"Das angegebene Buch kann nicht eingegeben werden, da es nicht in der Schulbuchliste gefunden wurde !\nODER\nEs wurde bei UeW mindestens ein falsches Format verwendet!");
  }
  else {
    try {
      sjstr=schuljahrtxt.getText();
...
//neue Abfrag (17.1.08) ob ein SBX Buch vorliegt, um das Fach aufjedenfall mit X zu merken - Rechnung!!
      if (anhang_liste_sbx == 0) fachin = "X-"+fachin;
      if (anhang_liste_sbxk == 0) fachin = "XK-"+fachin;
      String klassein = klassetxt;
      int lehrertest_zahl_0 = 0;
      ResultSet test = stmt.executeQuery("SELECT * FROM "+klassein+" ORDER BY Fach");
      while (test.next()) {
      ...
      if (nrtest_zahl == 0 && lehrertest_zahl_0 == 0) gefunden = true;
      if (nrtest_zahl == 0) Buch_gefunden = true;
      count++;
      }
      boolean sbx_pruefen = fachin.startsWith("X");
      if (sbx_pruefen == true || titelsbx == 0) {
        sbx = true;
        JOptionPane.showMessageDialog(null,"HINWEIS: Das Werk ist ein SBX-Buch!");
        }
      else sbx = false;
      if (gefunden == true || Buch_gefunden == true) {
        JOptionPane.showMessageDialog(null,"BuchNr. "+nrin+" ist bereits in der Klasse vorhanden !");
        if (gefunden == true && Buch_gefunden == true) gefunden = true;
        else {
          int response = JOptionPane.showConfirmDialog(null,"BuchNr. "+nrin+" trotzdem in die Klasse einfügen ?","Buch unter Lehrer "+lehrer+" einfügen",JOptionPane.YES_NO_OPTION);
          if (response == 0) gefunden = false;
          else gefunden = true;
          }
        }
        if (gefunden == true) JOptionPane.showMessageDialog(null,"Hinweis: Buch wurde nicht eingetragen!");
/*
---------------------------------------------------------
ACHTUNG !! in der folgenden Klammer steht ein ODER ||, wenn es zu einem && kippt - wird SBX wieder von der
Bestellung ausgenommen !! Im ODER - FALL kann SBX bestellt werden, aber ohne Lehrerhandexemplar!
---------------------------------------------------------
*/
        else if (gefunden == false || (titelsbx != 0 && anhang_liste_sbx != 0 && anhang_liste_sbxk != 0))  { //Start else-Zweig 2

        wiederverwendung();

        if (wvint < 0 || wvint > 99) wvint = 0;
        if (uew == true) sql = "INSERT INTO " +klassein+"(ID,Nr,Titel,Preis,Fach,Lehrer,W)" + " values("+count+",'"+nrin+"','UeW "+titelinuew+"',"+preisin+",'"+fachin+"','"+lehrer+"','"+wvint+"')";
        else sql = "INSERT INTO " +klassein+"(ID,Nr,Titel,Preis,Fach,Lehrer,W)" + " values("+count+",'"+nrin+"','"+titelin+"',"+preisin+",'"+fachin+"','"+lehrer+"','"+wvint+"')";
        stmt.executeUpdate(sql);
        JOptionPane.showMessageDialog(null,"Eingabe: BuchNr: "+nrin+" Titel: "+titelin+" Preis: €"+preisin+" Fach: "+fachin+" Klasse: "+klassein+" erfolgreich!");
        //als Lehrerhandexemplar einfügen ? Ausnahmen: UeW, Anhangliste und SBX Eingaben !!
        if (uew == false) {
          if (sbx == false && (titelsbx == -1 || anhang_liste_sbx == -1 || anhang_liste_sbxk == -1)) {
           if (anhang_liste_ja < 0 || anhang_liste_ja >0) {
            int response = JOptionPane.showConfirmDialog(null,"Als Lehrerhandexemplar einfügen ?","Lehrerhandexemplar",JOptionPane.YES_NO_OPTION);
            if (response == 0) {
              String lehrertmp = lehrertxt.getText();
              ResultSet test1 = stmt.executeQuery("SELECT * FROM LehrerHand ORDER BY Jahr");
              while (test1.next()) {
                String nrtest = test1.getString(2);
                int nrtest_zahl = nrin.compareTo(nrtest);
                int jahrtest = test1.getInt("Jahr");
                int jahrtest_zahl = Integer.parseInt(sjstr)-2000-jahrtest;
                String lehrertest = test1.getString(6);
                int lehrertest_zahl = lehrertmp.compareTo(lehrertest);
                if (nrtest_zahl == 0 && lehrertest_zahl == 0 && jahrtest_zahl >= 0 ) {
                  JOptionPane.showMessageDialog(null,"BuchNr "+nrin+" ist bereits als Lehrerhandexemplar enthalten bzw. wurde bereits erhalten !");
                  vorhanden = true;
                }
              }//Ende while-Schleife
              if (vorhanden == false && uew == false) {
                sql = "INSERT INTO LehrerHand (Nr, Titel, Fach, Jahr, Lehrer) VALUES ('"+nrin+"','"+titelin+"','"+fachin+"','"+(Integer.parseInt(sjstr)-2000)+"','"+lehrertmp+"')";
                stmt.executeUpdate(sql); String lehrerhand="LehrerHand";
                // umbenennen(X): ID fuer LehrerHand wird neu definiert!
                umbenennen(lehrerhand);
                JOptionPane.showMessageDialog(null,"BuchNr '"+nrin+"' wurde als Lehrerhandexemplar eingefügt !");
                }
            } // Ende if (response == 0)
           } // Ende if (anhang_liste_ja < 0 || anhang_liste_ja > 0)
           else JOptionPane.showMessageDialog(null,"Hinweis: Für Schulbücher aus der Anhangliste gibt es kein gratis Lehrerhandexemplar!");
          } // Ende if (sbx == false)
          else JOptionPane.showMessageDialog(null,"Hinweis: Für SBX-Bücher gibt es kein Lehrerhandexemplar!");
       } // Ende if (uew == false)
       else JOptionPane.showMessageDialog(null,"Hinweis: Für Schulbücher 'Unterrichtsmittel eigener Wahl' gibt es kein Lehrerhandexemplar!");
      } //Ende else-Zweig 2
      else if (titelsbx > -1 || anhang_liste_sbx > -1 || anhang_liste_sbxk > -1) JOptionPane.showMessageDialog(null,"Hinweis: SBX-Bücher können in diesem Schuljahr nicht bestellt werden!");
...
JOptionPane.showMessageDialog(null,"Im Schuljahr "+sjstr+" kein Einfügen möglich! \nGrund: "+ex.toString().substring(72,120));
      //ex.printStackTrace();
      }
    }
   }//Ende else-Zweig 1
  ...
  public void umbenennen(String klassein) {
      int z=0, count=0; int[] itmp= new int[10000];
      String sql="";
      ResultSet test1;
  ...
  try {
      ...
      if (klassein_zahl == 0)  test1 = stmt.executeQuery("SELECT * FROM "+klassein+" ORDER BY Jahr,Lehrer");
      else test1 = stmt.executeQuery("SELECT * FROM "+klassein+" ORDER BY Fach");
      count=0;
      while (test1.next()) {
  ...
  //Fortsetzung von 'umbenennen der ID' bzgl. Einfügen und Löschen eines Buches
  ...
  try {
      ...
      for (z=0;z<count;z++) {
        i=i+100;
        sql = "UPDATE "+klassein+" SET ID = "+i+" WHERE ID = "+itmp[z];
        itmp[z]=i;
        stmt.executeUpdate(sql);
        }
      i=0;
  ...
  if (lang1<1 || lang5<2) JOptionPane.showMessageDialog(null,"Bitte mindestens die Nummer und die Klasse (z.B. 1a) eingeben");
  else {
    try {
      sjstr=schuljahrtxt.getText();
      String url = "jdbc:odbc:sba"+sjstr;
      ...
      if (zahltest == 0 && zahltestlehrer == 0) gefunden = true;
      }
      if (gefunden == true) { //If-Zweig 1
      sql = "DELETE FROM "+klassein+" WHERE (Nr = '"+nrin+"' AND Lehrer = '"+lehrer+"')";
      stmt.executeUpdate(sql);
      JOptionPane.showMessageDialog(null,"Buch: "+nrin+" erfolgreich gelöscht!");
      //als Lehrerhandexemplar löschen
      lehrer = lehrertxt.getText();
      test = stmt.executeQuery("SELECT * FROM LehrerHand ORDER BY Jahr");
      while (test.next()) {
        ...
        if (vorhanden == true) {
          ...
          JOptionPane.showMessageDialog(null,"BuchNr '"+nrin+"' war nicht als Lehrerhandexemplar eingetragen bzw. wurde bereits erhalten !");
        }
      umbenennen(klassein);
      nrtxt.setText("");
      titeltxt.setText("");
      ...
      else JOptionPane.showMessageDialog(null,"ACHTUNG: BuchNr: "+nrin+" nicht gefunden ODER Buch unter einem anderen Lehrer eingegeben !");
      stmt.close();
      con.close();
      }

    catch (java.lang.Exception ex){
      JOptionPane.showMessageDialog(null,"Im Schuljahr "+sjstr+" kein Löschen möglich! \nGrund: "+ex.toString().substring(72,120));
      //ex.printStackTrace();
      }
    }
  }
  ...
  if (lang0 < 1 && lang1 < 1 && lang2 < 1) {
    JOptionPane.showMessageDialog(null,"Sie müssen entweder Nummer, Titel oder Fach eingeben");
    preistxt.setText("");
    klassecb1.setSelectedIndex(0);
    }
  else {
    ...
    rs = stmt.executeQuery(
     "SELECT * FROM Liste"+ " WHERE Nr = '"+nrin+"'");
     ...
     String c = rs.getString(3);
     clength = c.length();
     if (clength > 39) c = c.substring(0,39);
     clength = c.length();
     clength = 39-clength; if (clength > 31) Tab1="\t\t\t\t\t"; else if (clength > 23 && clength <= 31) Tab1="\t\t\t\t"; else if (clength > 15 && clength <= 23) Tab1="\t\t\t"; else if (clength > 7 && clength <= 15) Tab1 = "\t\t"; else if (clength <= 7) Tab1 = "\t";
     String d = rs.getString(4);
    ...
    rs = stmt.executeQuery(
     "SELECT * FROM Liste"+ " WHERE Titel LIKE '%"+titelin+"%'");
     output.setText("Das Ergebnis der Abfrage für die Schulbuchliste:\n\nNr.\tKurztitel d. Buches\t\t\tPreis\tFach\n"+
     "----------------------------------------------------------------------------------------------------------\n");
     while (rs.next()) {
     String b = rs.getString(2);
    ...
    rs.close();
     ...
     rs = stmt.executeQuery(
     "SELECT * FROM Liste"+ " WHERE Fach LIKE '%"+fachin+"%'");
     output.setText("Das Ergebnis der Abfrage für die Schulbuchliste:\n\n Nr.\tKurztitel d. Buches\t\t\tPreis\tFach\n"+
     "----------------------------------------------------------------------------------------------------------\n");
     while (rs.next()) {
     String b = rs.getString(2);
    ...
    if(treffer == 0) {
      JOptionPane.showMessageDialog(null,"Keine Entsprechungen gefunden - versuchen sie eine andere Eingabe");
      nrtxt.setText("");
      titeltxt.setText("");
      fachcb.setSelectedIndex(0);
    }
  ...
  try {
      ...
      Connection con = DriverManager.getConnection(url,"lehrer","jon96as12");
      Statement stmt = con.createStatement();
      int response = JOptionPane.showConfirmDialog(null,"Neue Schülerzahlen übernehmen ?","Schüleranzahl übernehmen",JOptionPane.YES_NO_OPTION);
      if (response == 0) {
        sql = "UPDATE schueler SET US = "+sus+", US_Religion = "+susr+", OS = "+sos+", OS_Religion = "+sosr;
        stmt.executeUpdate(sql);
        JOptionPane.showMessageDialog(null,"Schülerzahlen wurden neu übernommen !");
        }
      else JOptionPane.showMessageDialog(null,"Abbruch !");
      }
  catch (java.lang.Exception ex){
      ex.printStackTrace();
      }
  ...
  String lehrertest = lehrer;
  /*int allow = lehrertest.compareTo(""); FÜR ALLE LEHRER / USER
  if (allow == 0){*/
  ...
  schuljahrtxt.setEditable(true);
    try {
      String sjstr_neu = JOptionPane.showInputDialog(null,"Eingabe neues Schuljahr","Schuljahr wechseln",JOptionPane.QUESTION_MESSAGE);
      try {
      sjstr=schuljahrtxt.getText();
      String url = "jdbc:odbc:sba"+sjstr;
      Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
      ...
      if (eintrag_yes == true) JOptionPane.showMessageDialog(null,"Schuljahr "+sjstr+" wird übernommen!");
      else JOptionPane.showMessageDialog(null,"Schuljahr nicht vorhanden !");

      int sjneu = sjstr.compareTo("");
      if (sjneu == 0 || eintrag_yes == false) JOptionPane.showMessageDialog(null,"Gleiches Schuljahr !");
  ...
  if (allow == 0) {
    try {
      FileWriter file = new FileWriter("C:/db_sba/pwd.doc");
      output.setText("");
      try  {
        sjstr=schuljahrtxt.getText();
        String url = "jdbc:odbc:sba"+sjstr;
    ...
    //Datumseingabe
    String date = JOptionPane.showInputDialog(null,"Datum vom:","Datumseingabe",JOptionPane.QUESTION_MESSAGE);
    try {
    ...
    String info1 = JOptionPane.showInputDialog(null,"Zeitraum:","Zeitraum der Eingabe",JOptionPane.QUESTION_MESSAGE);
    try {
      int info1int = info1.compareTo("");
      if (info1int < 0 || info1int > 0) info1 = "Zeitraum der Eingabe: "+info1+"\n \n";
    }
    catch (java.lang.Exception ex) {
      info1="";
    }
    //INFO2 - Eingabe zum Ort
    String info2 = JOptionPane.showInputDialog(null,"Örtlichkeit:","Ort der Eingabe",JOptionPane.QUESTION_MESSAGE);
    try {
      int info2int = info2.compareTo("");
      if (info2int < 0 || info2int > 0) info2 = "Ort der Eingabe: "+info2+"\n \n";
    }
    catch (java.lang.Exception ex) {
      info2="";
    }
    ...
    for (l=0;l<anz_lehrer;l++) {
      file.write("Die persönlichen Daten für die Anmeldung zum Programm für die Schulbuchaktion "+date+"\n \n");
      file.write("Benutzer: "+ benutzer[l] + "  Passwort: " + pwdbenutzer[l] + "\n \n");
      for (pwd_counter=0;pwd_counter<5;pwd_counter++) {
        pwd[pwd_counter]=pwdbenutzer[l].charAt(pwd_counter);
        //new pwdlang(pwd);
        switch((char)(pwd[pwd_counter])) {
          case 'a': {pwdwort[pwd_counter]="anton"; break;}
          case 'A': {pwdwort[pwd_counter]="Anton"; break;}
          case 'b': {pwdwort[pwd_counter]="berta"; break;}
          case 'B': {pwdwort[pwd_counter]="Berta"; break;}
          case 'c': {pwdwort[pwd_counter]="caesar"; break;}
          case 'C': {pwdwort[pwd_counter]="Caesar"; break;}
          case 'd': {pwdwort[pwd_counter]="dora"; break;}
          case 'D': {pwdwort[pwd_counter]="Dora"; break;}
          case 'e': {pwdwort[pwd_counter]="emil"; break;}
          case 'E': {pwdwort[pwd_counter]="Emil"; break;}
          case 'f': {pwdwort[pwd_counter]="friedrich"; break;}
          case 'F': {pwdwort[pwd_counter]="Friedrich"; break;}
          case 'g': {pwdwort[pwd_counter]="gustav"; break;}
          case 'G': {pwdwort[pwd_counter]="Gustav"; break;}
          case 'h': {pwdwort[pwd_counter]="heinrich"; break;}
          case 'H': {pwdwort[pwd_counter]="Heinrich"; break;}
          case 'i': {pwdwort[pwd_counter]="ida"; break;}
          case 'I': {pwdwort[pwd_counter]="Ida"; break;}
          case 'j': {pwdwort[pwd_counter]="julius"; break;}
          case 'J': {pwdwort[pwd_counter]="Julius"; break;}
          case 'k': {pwdwort[pwd_counter]="konrad"; break;}
          case 'K': {pwdwort[pwd_counter]="Konrad"; break;}
          case 'l': {pwdwort[pwd_counter]="ludwig"; break;}
          case 'L': {pwdwort[pwd_counter]="Ludwig"; break;}
          case 'm': {pwdwort[pwd_counter]="martha"; break;}
          case 'M': {pwdwort[pwd_counter]="Martha"; break;}
          case 'n': {pwdwort[pwd_counter]="nordpol"; break;}
          case 'N': {pwdwort[pwd_counter]="Nordpol"; break;}
          case 'o': {pwdwort[pwd_counter]="otto"; break;}
          case 'O': {pwdwort[pwd_counter]="Otto"; break;}
          case 'p': {pwdwort[pwd_counter]="paula"; break;}
          case 'P': {pwdwort[pwd_counter]="Paula"; break;}
          case 'q': {pwdwort[pwd_counter]="ku"; break;}
          case 'Q': {pwdwort[pwd_counter]="Ku"; break;}
          case 'r': {pwdwort[pwd_counter]="richard"; break;}
          case 'R': {pwdwort[pwd_counter]="Richard"; break;}
          case 's': {pwdwort[pwd_counter]="siegfried"; break;}
          case 'S': {pwdwort[pwd_counter]="Siegfried"; break;}
          case 't': {pwdwort[pwd_counter]="theodor"; break;}
          case 'T': {pwdwort[pwd_counter]="Theodor"; break;}
          case 'u': {pwdwort[pwd_counter]="ulrich"; break;}
          case 'U': {pwdwort[pwd_counter]="Ulrich"; break;}
          case 'v': {pwdwort[pwd_counter]="viktor"; break;}
          case 'V': {pwdwort[pwd_counter]="Viktor"; break;}
          case 'w': {pwdwort[pwd_counter]="wilhelm"; break;}
          case 'W': {pwdwort[pwd_counter]="Wilhelm"; break;}
          case 'x': {pwdwort[pwd_counter]="xaver"; break;}
          case 'X': {pwdwort[pwd_counter]="Xaver"; break;}
          case 'y': {pwdwort[pwd_counter]="ypsilon"; break;}
          case 'Y': {pwdwort[pwd_counter]="Ypsilon"; break;}
          case 'z': {pwdwort[pwd_counter]="zuerich"; break;}
          case 'Z': {pwdwort[pwd_counter]="Zuerich"; break;}
          case '0': {pwdwort[pwd_counter]="null"; break;}
          case '1': {pwdwort[pwd_counter]="eins"; break;}
          case '2': {pwdwort[pwd_counter]="zwei"; break;}
          case '3': {pwdwort[pwd_counter]="drei"; break;}
          case '4': {pwdwort[pwd_counter]="vier"; break;}
          case '5': {pwdwort[pwd_counter]="fuenf"; break;}
          case '6': {pwdwort[pwd_counter]="sechs"; break;}
          case '7': {pwdwort[pwd_counter]="sieben"; break;}
          case '8': {pwdwort[pwd_counter]="acht"; break;}
          case '9': {pwdwort[pwd_counter]="neun"; break;}
          default: {pwdwort[pwd_counter]=""+pwd[pwd_counter];}
          }
        }
      file.write("In Worten: "+pwdwort[0]+"-"+pwdwort[1]+"-"+pwdwort[2]+"-"+pwdwort[3]+"-"+pwdwort[4]+"\n\n");
      file.write(info1);
      file.write(info2);
      file.write("Es besteht die Möglichkeit bei allen vier Geräten im Konferenzzimmer über\n START-LEHRER-SCHULBUCHAKTION\n das Programm für die Eingabe zu starten.\f");
      }
    file.close();
    }
    ...
    JOptionPane.showMessageDialog(null,l+ " Benutzer und Passwörter auf C:/sba_files/pwd.doc geschrieben !");
  }
  else JOptionPane.showMessageDialog(null,"Keine Berechtigung");
  }
  ...
  String wv = JOptionPane.showInputDialog(null,"Anzahl der Bücher zur Wiederverwendung ?","Wiederverwendete Bücher",JOptionPane.QUESTION_MESSAGE);
  ...
  try{
    ...
    if (wvtmp == 0) {
      ...
      if (wvint<0 || wvint > 99) {
        JOptionPane.showMessageDialog(null,"Sie können nur eine Zahl zwischen 0 und 99 eingeben");
        return(wiederverwendung());
        }
      else {
        return(wvint);
  ...
  public void actionPerformed(ActionEvent evt) {
    Object source = evt.getSource();
    if (source == klassebtn) anzeigen(klassecb);
    if (source == insertbtn) {
      sjstr = schuljahrtxt.getText();
      lehrer = lehrertxt.getText();
      int sjstrtest_sj = sjstr.compareTo(anmeldesjstr);
      int allow_eingabe = lehrer.compareTo("ADM");
      if (sjstrtest_sj == 0 || allow_eingabe == 0) eingabe(lehrer);
      else JOptionPane.showMessageDialog(null,"Im Schuljahr "+sjstr+" ist keine Eingabe möglich !");
      }
    if (source == deletebtn) {
      sjstr = schuljahrtxt.getText();
      lehrer = lehrertxt.getText();
      int sjstrtest_sj = sjstr.compareTo(anmeldesjstr);
      int allow_eingabe = lehrer.compareTo("ADM");
      if (sjstrtest_sj == 0 || allow_eingabe == 0) loesche();
      else JOptionPane.showMessageDialog(null,"Im Schuljahr "+sjstr+" ist kein Löschen möglich !");
      }
    if (source == searchbtn) suchen();
    if (source == pwdaendernbtn) pwdaendern();
    if (source == druckbtn) drucken();
    if (source == resetbtn) clear();
    }
